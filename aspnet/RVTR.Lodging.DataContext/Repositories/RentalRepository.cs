  ...
  public class RentalRepository : Repository<RentalModel, RentalQueryParamsModel>
  {
    ...
    private IQueryable<RentalModel> IncludeQuery()
    {
      return dbContext.Rentals
        ...
        .Include(x => x.RentalUnit).ThenInclude(x => x.Bedrooms).ThenInclude(x => x.BedType);
    }
    ...
    /// <param name="queryParams"></param>
    /// <returns></returns>
    public static FilterFuncs GenerateFilterFuncs(RentalQueryParamsModel queryParams)
    {
      ...
      if (!String.IsNullOrEmpty(queryParams.HasBedType))
      {
        filters.Add(r => r.RentalUnit.Bedrooms.FirstOrDefault(
                      b => b.BedType.BedType == queryParams.HasBedType) != null);
      }
    ...
    /// <param name="queryParams"></param>
    /// <returns></returns>
    public static OrderByFunc GenerateOrderByFunc(RentalQueryParamsModel queryParams)
    {
